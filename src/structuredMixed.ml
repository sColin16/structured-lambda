...
let is_even_type = Label "isEven"
let is_odd_type = Label "isOdd"
let is_even_term = Const "isEven"
let is_odd_term = Const "isOdd"
...
let is_even_odd =
  Fix
    (Abstraction
       [
         ( [ Function [ ([ is_even_type ], [ num_to_bool ]) ] ],
           Abstraction
             [
               ( [ is_even_type ],
                 Abstraction
                   [
                     ...
                     ( [
                       ...
                       Application
                         ( Application (Variable 2, is_odd_term),
                           Application (decrement, Variable 0) ) );
                   ] );
             ] );
         ( [ Function [ ([ is_odd_type ], [ num_to_bool ]) ] ],
           Abstraction
             [
               ( [ is_odd_type ],
                 Abstraction
                   [
                     ...
                     ( [
                       ...
                       Application
                         ( Application (Variable 2, is_even_term),
                           Application (decrement, Variable 0) ) );
                   ] );
             ] );
       ])
